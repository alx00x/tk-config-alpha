...
#            return
        ...
        #Crater addition ===============================================================================
        # get review folder path defined in the template.yml and assign to movies_dir var
        #===============================================================================================
        ...
        # Crater addition ==================================================================================
        # includes image sequences when collecting playblasts
        # ==================================================================================================
        ...
        for filename in os.listdir(movies_dir):
            ...
            # Crater addition ==================================================================================
            # check if playblast name corresponds to the scene name so only playblasts from the current session are listed
            if self.compare_filename_to_maya_scene_name(filename):
    ...
    # Crater addition ==================================================================================
    # compare filename to maya scene name
    def compare_filename_to_maya_scene_name(self, filename):     
        publisher = self.parent
        # get the path to the current file
        path = cmds.file(query=True, sn=True)
        ...
        # determine maya scene file name without extension
        file_info = publisher.util.get_file_path_components(path)
        maya_scene_name = file_info["filename"].split('.')[0]
        
        if filename == maya_scene_name:
            return True
        else:
            return False
    # ==================================================================================================
